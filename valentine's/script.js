...
const gifElement = document.getElementById("kuromi-gif");
...
const gifs = ["./areyousure.gif", "./kuromi-sad.gif", "./kuromi-crying.gif", "./kuromi-axe.gif"];
// array of messages
const buttonMessages = ["Are you sure??", "you dont lob me?", "you hate me?? :(((((", "chup chap yes click kar!"];
